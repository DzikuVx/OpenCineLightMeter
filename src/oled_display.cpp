...
void OledDisplay::renderPageEV() {
    ...
    if (settings.mode == LIGHT_METER_MODE_ISO) {
        //TODO
        // _display->drawString(0, 24, String(isoIndex));
    } else if (settings.mode == LIGHT_METER_MODE_APERTURE) {
        ...
        //TODO
        // _display->drawString(0, 24, String(shutterIndex));
    }
